...
function App() {
  ...
  const handleGenerate = useCallback(async (promptOverride?: string) => {
    ...
    try {
      ...
      // Default to showing the actual error message from the API for better debugging by the user.
      let displayMessage = `Failed to generate image: ${errorMessage}`;
      ...
      if (errorMessage.includes('API_KEY_INVALID') || errorMessage.includes('API key not valid')) {
        ...
        displayMessage = 'The API call succeeded but returned no images. Please try a different prompt.';
      }
