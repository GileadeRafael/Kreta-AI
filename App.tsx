...
function App() {
  ...
  const handleGenerate = useCallback(async (promptOverride?: string) => {
    ...
    try {
      const images = await generateImage(activePrompt, settings.aspectRatio, settings.numImages, apiKey);
      
      let title = "Creation";
      try {
         title = await generateTitle(activePrompt, apiKey);
      } catch (e) {
      ...
      let displayMessage = 'Failed to generate image. Please try again later.';
      ...
      if (errorMessage.includes('SAFETY')) {
        ...
        displayMessage = 'Invalid API Key. Please check your settings.';
        setShowApiKeyModal(true); // Re-open modal if key fails
      }
